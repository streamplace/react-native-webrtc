...
interface NativeVideoViewProps extends RTCVideoViewBaseProps {
    onPictureInPictureChange?: (event: NativeSyntheticEvent<{
...
declare const NativeRTCVideoView: import("react-native").HostComponent<NativeVideoViewProps>;
declare class RTCView extends React.PureComponent<RTCVideoViewProps> {
